...
conda run -n GLTSSL --no-capture-output python train_mscoco_glt.py --img_size 112 --epoch 500 --val-iteration 500 --out ./results/mscoco_glt_112x112/fixmatch/baseline/resnet50 --gpu 0,1 --batch-size 64
echo "Fixmatch Done!!"
